...
Create a C++ program that asks the user for their favorite number between 1 and
100 then read this number from the console.
...
int main() {
  int fav_num;
  std::cout << "Choose your favourite number between 1 and 100: ";
